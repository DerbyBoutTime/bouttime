...
exports.GameForm = React.createClass
  ...
  bindActions: (teamType) ->
    Object.keys(@props.actions).map((key) ->
      key: key
      value: @props.actions[key].bind(this, teamType)
  ...
  render: () ->
    <form className='game-form' onSubmit={@handleSubmit}>
      ...
      <TeamFields teamType='home' teamState={@props.gameState.homeAttributes} actions={@bindActions('home')}/>
      <TeamFields teamType='away' teamState={@props.gameState.awayAttributes} actions={@bindActions('away')}/>
