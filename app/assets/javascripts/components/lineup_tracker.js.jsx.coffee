    ...
    `<div className="lineup-tracker-view">
      <div className="row teams text-center gutters-xs">
        <div className="col-sm-6 col-xs-6">
          <div className="boxed-good team-name" style={this.state.away.colorBarStyle} onClick={this.handleToggleTeam}>
            {this.state.away.name}
          </div>
        </div>
        <div className="col-sm-6 col-xs-6">
          <div className="boxed-good team-name" style={this.state.home.colorBarStyle} onClick={this.handleToggleTeam}>
        ...
        <div className="col-sm-6 col-xs-12" id="away-team">
          <div className="row gutters-xs jam-detail">
            ...
            <div className="col-sm-2 col-xs-2">
              <div className="boxed-good jam-detail-no-pivot text-center">
                <strong>No Pivot</strong>
              </div>
            </div>
            <div className="col-sm-2 col-xs-2">
              <div className="boxed-good jam-detail-star-pass text-center">
          ...
          <div className="row gutters-xs skaters">
            <div className="col-sm-2 col-xs-2 col-sm-offset-2 col-xs-offset-2">
              <div className="boxed-good skater text-center">
                2LBU
              </div>
            </div>
            <div className="col-sm-2 col-xs-2">
            ...
            <div className="col-sm-2 col-xs-2">
              <div className="boxed-good skater skater-injury text-center">
                1701
              </div>
            </div>
            <div className="col-sm-2 col-xs-2">
          ...
          <div className="row gutters-xs boxes">
            <div className="col-sm-1 col-xs-1 col-sm-offset-1 col-xs-offset-1">
              <div className="boxed-good box-toggle text-center">
                <span className="glyphicon glyphicon-chevron-down" aria-hidden="true"></span>
              </div>
            </div>
            <div className="col-sm-2 col-xs-2">
              <div className="boxed-good box text-center">
                <strong>X</strong>
              </div>
            </div>
            <div className="col-sm-2 col-xs-2">
            ...
            <div className="col-sm-2 col-xs-2">
              <div className="boxed-good box box-injury text-center">
          ...
          <div className="row gutters-xs actions">
            <div className="col-sm-6 col-xs-6">
              <div className="boxed-good actions-action actions-edit text-center">
                END
              </div>
            </div>
            <div className="col-sm-6 col-xs-6">
              <div className="boxed-good actions-action actions-undo text-center">
                <strong>UNDO</strong>
              </div>
            </div>
          </div>
