    ...
    `<div className="lineup-tracker">
      <div className="row teams text-center gutters-xs">
        <div className="col-sm-6 col-xs-6">
          <div className="boxed-good team-name" style={this.props.awayAttributes.colorBarStyle} onClick={this.handleToggleTeam}>
            {this.props.awayAttributes.name}
          </div>
        </div>
        <div className="col-sm-6 col-xs-6">
          <div className="boxed-good team-name" style={this.props.homeAttributes.colorBarStyle} onClick={this.handleToggleTeam}>
    ...
    `<div>
      <div className="row gutters-xs jam-detail">
        <div className="col-sm-8 col-xs-8">
          <div className="boxed-good jam-detail-number">
            <div className="row gutters-xs">
      ...
      <div className="row gutters-xs skaters">
        <div className="col-sm-2 col-xs-2 col-sm-offset-2 col-xs-offset-2">
          <SkaterSelector number={this.props.data.pivot_number} />
        </div>
        <div className="col-sm-2 col-xs-2">
          <SkaterSelector number={this.props.data.blocker_1_number} />
        </div>
        <div className="col-sm-2 col-xs-2">
          <SkaterSelector number={this.props.data.blocker_2_number} />
        </div>
        <div className="col-sm-2 col-xs-2">
          <SkaterSelector number={this.props.data.blocker_3_number} />
        </div>
        <div className="col-sm-2 col-xs-2">
          <SkaterSelector number={this.props.data.jammer_number} />
        </div>
      </div>
      ...
      <div className={actionsClass}>
        <div className="col-sm-6 col-xs-6">
          <button className="boxed-good actions-action actions-edit text-center btn btn-block" onClick={this.props.endHandler}>
            END
          </button>
        </div>
        <div className="col-sm-6 col-xs-6">
          <button className="boxed-good actions-action actions-undo text-center btn btn-block" onClick={this.props.undoHandler}>
            <strong>UNDO</strong>
          </button>
        </div>
      </div>
...
exports.SkaterSelector = React.createClass
  render: () ->
    `<div className="boxed-good skater-selector text-center">
...
exports.LineupBox = React.createClass
  ...
  render: () ->
    ...
    `<button className="boxed-good box text-center btn btn-block btn-box" onClick={this.props.boxHandler}>
