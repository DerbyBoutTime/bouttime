    ...
    `<div className="scoreboard" id="scoreboard">
      <section className="team home">
        ...
        <div className="jammer home-team-jammer">
          <div className="lead-status">
            <span className="glyphicon glyphicon-star" className={this.state.homeAttributes.jammerAttributes.lead ? '' : 'hidden'}></span>
          </div>
          <div className="name">{this.state.homeAttributes.jammerAttributes.number} {this.state.homeAttributes.jammerAttributes.name}</div>
        </div>
      ...
      <section className="clocks">
        <div className="clocks-border">
          ...
          <div className="period-clock">
            ...
            <div className="clock period-clock">{this.state.periodClockAttributes.display}</div>
          </div>
          <div className="jam-clock">
            <label className="jam-clock-label">{this.state.state}</label>
            <div className="clock">{this.state.jamClockAttributes.display}</div>
          </div>
        </div>
      ...
      <section className="team away">
        ...
        <div className="jammer away-team-jammer">
          <div className="lead-status">
            <span className="glyphicon glyphicon-star {this.state.awayAttributes.jammerAttributes.lead ? '' : 'hidden'}"></span>
          </div>
          <div className="name">{this.state.awayAttributes.jammerAttributes.number} {this.state.awayAttributes.jammerAttributes.name}</div>
        </div>
