...
ActiveRecord::Schema.define(version: 20150331174426) do
  ...
  create_table "penalty_box_states", force: true do |t|
    ...
    t.datetime "updated_at"
    t.integer  "team_state_id"
    t.integer  "sat_in_jam"
    t.string   "position"
    t.integer  "sat_time_remaining"
    t.integer  "warn_time_remaining"
    t.integer  "release_time_remaining"
    t.integer  "jam_end_time_remaining"
  end
  ...
  add_index "penalty_box_states", ["team_state_id"], name: "index_penalty_box_states_on_team_state_id", using: :btree
